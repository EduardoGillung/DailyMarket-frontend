  ...
  return (
    <Tabs defaultValue="orders">
      <TabsList className="rounded-xl bg-white">
        <TabsTrigger value="orders" className="text-2xl text-PrimaryGrey font-redHat font-bold rounded-xl hover:text-white hover:bg-dailyPrimary">Pedidos</TabsTrigger>
      ...
      <TabsContent
        value="orders"
        className="space-y-5 bg-white p-10 rounded-xl font-redHat"
      >
